...
export const Register = () => {
  const { user, registerUser, signInWithGoogle } = useShop();
      ...
      <div className="container auth-container animate-scale-in">
        <div className="auth-card">
          <div className="auth-header">
            ...
            <p className="text-secondary">Join Aura Wear to receive order tracking updates and save delivery details.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            <button type="submit" className="btn btn-primary w-full auth-submit-btn">
              <CheckCircle size={18} /> Register Account
            </button>
          </form>
          ...
          <div className="auth-footer text-center">
            <p>Already have an account? <Link to="/login" className="auth-swap-link">Sign In</Link></p>
          </div>
        </div>
      </div>
